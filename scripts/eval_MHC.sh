...
MHC_graph=chr6.pan.fa.a2fb268.4030258.6a1ecc2.smooth.mhc.sorted.gfa
...
${profiling} ${graphaligner_heuristics} -x vg -g ${MHC_graph} -f ${hg002_1_MHC} -a HG002.1.MHC.graphaligner.gaf
${profiling} ${graphaligner_heuristics} -x vg -g ${MHC_graph} -f ${hg002_2_MHC} -a HG002.2.MHC.graphaligner.gaf

${profiling} ${graphaligner_heuristics} -x vg -g ${MHC_graph} -f ${hg005_1_MHC} -a HG005.1.MHC.graphaligner.gaf
${profiling} ${graphaligner_heuristics} -x vg -g ${MHC_graph} -f ${hg005_2_MHC} -a HG005.2.MHC.graphaligner.gaf

${profiling} ${graphaligner_heuristics} -x vg -g ${MHC_graph} -f ${na19240_1_MHC} -a NA19240.1.MHC.graphaligner.gaf
${profiling} ${graphaligner_heuristics} -x vg -g ${MHC_graph} -f ${na19240_2_MHC} -a NA19240.2.MHC.graphaligner.gaf

conda deactivate

#astarix
${profiling} ${astarix} align-optimal -G 1 -g ${MHC_graph} -q ${hg002_1_MHC} -o HG002.1.MHC.astarix.gaf
${profiling} ${astarix} align-optimal -G 1 -g ${MHC_graph} -q ${hg002_2_MHC} -o HG002.2.MHC.astarix.gaf

${profiling} ${astarix} align-optimal -G 1 -g ${MHC_graph} -q ${hg005_1_MHC} -o HG005.1.MHC.astarix.gaf
${profiling} ${astarix} align-optimal -G 1 -g ${MHC_graph} -q ${hg005_2_MHC} -o HG005.2.MHC.astarix.gaf

${profiling} ${astarix} align-optimal -G 1 -g ${MHC_graph} -q ${na19240_1_MHC} -o NA19240.1.MHC.astarix.gaf
${profiling} ${astarix} align-optimal -G 1 -g ${MHC_graph} -q ${na19240_2_MHC} -o NA19240.2.MHC.astarix.gaf
